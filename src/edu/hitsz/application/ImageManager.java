...
public class ImageManager {
    ...
    public static BufferedImage ELITEPLUS_IMAGE;
    ...
    static {
        try {
            ...
            BACKGROUND_IMAGE_COMMON = ImageIO.read(new FileInputStream("src/images/bg2.jpg"));
            ...
            ELITEPLUS_IMAGE = ImageIO.read(new FileInputStream("src/images/elitePlus.png"));
            ...
            CLASSNAME_IMAGE_MAP.put(ElitePlusEnemy.class.getName(), ELITEPLUS_IMAGE);
